...
/**
 * Loads and configures photorealistic NASA Blue Marble Earth textures
 */
export function loadEarthTextures() {
  ...
  const dayTexture = textureLoader.load(
    ...
    undefined,
    () => {
      // Fallback to procedural canvas if local asset is inaccessible
  ...
  // 3. Topographical Mountain & Trench Normal Map
